            ...
            if (req.isAuthenticated()) {
                if (req.user.rolN !== 'director') {
                    ...
                    res.render('fragmentos/rolPrincipal', {
                        ...
                        footer: 'footerX',
                        obras: obrasTemp,
                        regReserva: 'registro/registrarReserva',
                        view: 'esRegReserva'
                    });
                } else {
        ...
        Reserva.findOne({where: {id_obra: req.body.obra, exteral_idCuenta: req.user.id_cuenta}}).then(reserva => {
            if (reserva) {
                ...
                Reserva.create({
                    ...
                    fechasRetiroBoletos: moment(fechaHoy).add(3, 'days').format('YYYY[-]MM[-]DD'),
    ...
    modificarReserva(req, res) {
        Reserva.update({
            ...
            if (updatedReserva) {
                ...
                console.log('NO actualizado su reserva');
            }
        });
    }
